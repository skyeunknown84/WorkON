...
if(isset($_POST['request'])){
    ...
    $filter_status = "SELECT *,concat(firstname,' ',lastname) AS assignee FROM users u INNER JOIN project_list p  WHERE status = '$request'  AND type BETWEEN 2 AND 3 AND p.proj_status='1'";
