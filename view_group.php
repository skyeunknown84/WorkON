		...
		<div class="col-md-12">
			<div class="card card-outline card-success">
				<div class="card-header">
					<b>TASK FILE/S</b>
					<div class="card-tools">
						<button class="btn btn-primary bg-primary btn-sm" type="button" id="new_productivity"><i class="fa fa-plus"></i> Add Task File/s</button>
					</div>
				</div>
				<div class="card-body">
					<?php 
